...
import java.awt.event.*;
    ...
    public class Galaxy implements Runnable, KeyListener {
        ...
        public Image astronaughtPic;
        public Image CosmosPic;

        //Declare the character objects
        public Mouse mouse1;
        public Astroid theAstroid;
        public Player user;
        ...
        public Galaxy() {
            ...
            asteroidPic = Toolkit.getDefaultToolkit().getImage("astronaught.png");
            CosmosPic = Toolkit.getDefaultToolkit().getImage("Cosmos.jpg");
...
//User Method Section
        ...
        public void render() {
            ...
            g.drawImage(asteroidPic, asteroidPic.xpos, asteroidPic.ypos, asteroidPic.width, asteroidPic.height, null);
            g.drawImage(astronaughtPic.pic, astronaughtPic.xpos, astronaughtPic.ypos, astronaughtPic.width, astronaughtPic.height, null);
...
//        }
        ...
        public void setUpGraphics() {
            frame = new JFrame("Cosmos.jpg");   //Create the program window or frame.  Names it.
